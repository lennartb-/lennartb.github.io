...
![RSF Launcher telemetry settings](/images/11-24-rsf-telemetry-settings.png) "Image showing RSF Launcher UDP telemetry page with predefined settings 127.0.0.1:6776")
